...
setwd("~/Desktop/Research Final/Mortality/Figures/Final Figures/Final Covid Figures/Mort17")
ggsave( paste("Mortality_Specialist_ZeroOut_OLS_Ridge_NewBestObj_", mnYr, ".pdf"),
        plot   = plt,
        width  = 8,
        height = 4)
...
setwd("~/Desktop/Research Final/Mortality/Figures/Final Figures/Final Covid Figures/Mort17")
ggsave( paste("Mortality_Specialist_ZeroOut_OLS_Ridge_New_NoLinearBest_", mnYr, ".pdf"),
        plot   = plt,
        width  = 8,
        height = 4)
...
setwd("~/Desktop/Research Final/Mortality/Figures/Final Figures/Final Covid Figures/Mort17")
ggsave( paste("Mortality_Specialist_ZeroOut_OLS_Ridge_New_OldvsNew_", mnYr, ".pdf"),
        plot   = plt,
        width  = 8,
        height = 4)    
